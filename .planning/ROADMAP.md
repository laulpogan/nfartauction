...
- [x] 05-02-PLAN.md — End state: round-4 game_over transition, computeFinalAppraisal pure function, APPRAISAL_TEMPLATES, EndStateAppraisal component replacing GameOverModal body, receipt-format leaderboard
**UI hint**: yes
...
- [x] 07-02-PLAN.md — Server bot integration: SET_BOT_COUNT handler, bot session creation at START_GAME, bot turn executor, bot sim day auto-submit (BOT-01, BOT-06)
- [x] 07-03-PLAN.md — Lobby UI: bot count selector for host, bot player display with "Bot" chip (BOT-01)
