...
Plans:
- [ ] 03-01: Type layer — GamePhase discriminated union, SimState, PlayerSimState, new message schemas
- [ ] 03-02: sim-engine.ts — resolveSlots, advanceDay, applySimModifiers (pure functions + tests)
- [ ] 03-03: Server phase machine — SUBMIT_SLOTS handler, YOUR_SIM_STATE dispatch, 60-second timeout, KV split
- [ ] 03-04: SimPanel UI — slot picker, neighborhood map, stat display in wall-label format, Zustand stores
**UI hint**: yes
